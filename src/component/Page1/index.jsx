...
export const Page1 = React.memo(() => {
    return (
        <div>
            ...
            <div className="divs1">
                <h1 className="divs1_h1">Ինտերնետ Սակագնային Փաթեթներ Single</h1>
            ...
            <div className="div7">
                ...
                <div className="div7_2">
                    <p className="linker">Փաթեթներ</p>
                    <p className="linker">Ծառայություններ</p>
                    <p className="linker">Տան համար</p>
